...
nearApiScript.type = "text/javascript";
nearApiScript.src = "https://cdn.jsdelivr.net/npm/near-api-js@1.1.0/dist/near-api-js.js";
nearApiScript.onload = () => {
    const borshScript = document.createElement("script");
    borshScript.type = "text/javascript";
    borshScript.src = "./web3/borsh.bundle.js";
    borshScript.onload = initializeNearAPI;
    document.body.appendChild(borshScript);
};
document.body.appendChild(nearApiScript);

function initializeNearAPI() {
